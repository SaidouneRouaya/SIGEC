...
<!-- Header content -->
   ...
   <section class="content">
    <h2 class="page-header"></h2>
     ...
     <div class="col-md-3">
        <a href="completerDossier.aspx" class="btn btn-block btn-success btn-sm">Complet</a> 
          <a href="dossierAttentes.aspx" class="btn btn-block btn-danger btn-sm">En attente</a>
        </div>
