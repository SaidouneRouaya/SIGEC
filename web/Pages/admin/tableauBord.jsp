...
<div class="wrapper">
          ...
          <div class="box">
           <div class="box box-success">
            <div class="box-header with-border">
              <h3 class="box-title">Le nombre de reussite des candidat par rapport au nombre d'echecs par annee</h3>
  ...
  40
        ...
        <!-- /.col -->
         ...
         <div class="col-md-4">
            ...
            <div class="info-box-content">
              ...
              <span class="progress-description">
                    Environ 20% des candidat ont ete classes avec mention
                  </span>
            </div>
            <!-- /.info-box-content -->
          </div>
        ...
        <div class="info-box bg-red">
          ...
          <div class="info-box bg-yellow">
            ...
            <div class="info-box-content">
              ...
              <span class="progress-description">
                    Diminue d'environ 5% chaque annee
                  </span>
            </div>
            <!-- /.info-box-content -->
          </div>
        ...
        <div class="col-md-6">
          <!-- MAP & BOX PANE -->
            ...
            <div class="box-header with-border">
              <h3 class="box-title">L'evolution du nombre de candidatures pour Femme/Hommes </h3>
  ...
  5,713
        ...
        <div class="box box-danger">
            <div class="box-header with-border">
              <h3 class="box-title">Le taux de reussite par rapport au echecs et aux rejets</h3>
