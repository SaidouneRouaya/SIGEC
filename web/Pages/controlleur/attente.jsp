...
<title>SIGEC | Liste candidats</title>
  	...
  	<%@ include file="../controlleur/menu-controlleur.jsp" %>
		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				<h1>
					Liste des dossiers en attente <small></small>
				</h1>
				<ol class="breadcrumb">
					<li><a href="#"><i class="fa fa-dashboard"></i> Acceuil</a></li>
					<li class="active">Liste des dossiers en attente</li>
				</ol>
			</section>
			<!--  listeUtilisateurs  -->
		<sw:forEach begin="0" end="${ListeDossierAttente.size()-1}" var="i" >
